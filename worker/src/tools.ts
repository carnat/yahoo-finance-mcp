...
const DEPRECATED_ALIAS_TOOLS: Tool[] = [
  ...
  { name: "get_dc134_options_scan", description: "Deprecated alias for get_options_flow_scan.", inputSchema: { type: "object", properties: { ticker: { type: "string" }, window_label: { type: "string" } }, required: ["ticker", "window_label"] }, deprecated: true, useInstead: "get_options_flow_scan", deprecationReason: "Use the canonical public tool name." },
